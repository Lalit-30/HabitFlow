      ...
      <div className="flex items-start justify-between gap-4">
        ...
        <div className="flex items-start gap-4 flex-1">
          ...
          <div className="space-y-1 flex-1 min-w-0">
            ...
            <div className="flex items-center gap-4 pt-2 text-xs font-medium text-slate-300">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative">
            ...
            {showMenu && (
              <div className="absolute right-0 top-10 w-36 glass-panel p-1 z-20 shadow-2xl border border-slate-700 text-xs">
                {onEdit && (
                  <button
                    onClick={() => { setShowMenu(false); onEdit(habit); }}
                    className="w-full flex items-center gap-2 px-3 py-2 text-slate-300 hover:bg-slate-800 rounded-lg transition-colors"
                  >
